...
const COLUMNS: Column<SaleRow>[] = [
  ...
  { key: "qty", header: "Bán ra", sortable: true, className: "text-right", render: (r) => <span>{formatNumber(r.qty)}</span> },
...
export default function BaoCaoHangHoaPage() {
  return (
    <AdminListPage<SaleRow>
      ...
      exportFilename="bao-cao-hang-hoa"
      minWidth={1000}
    />
  );
}
